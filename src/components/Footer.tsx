    ...
    <footer className="border-t border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 mt-16 ">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          {/* Empty space - takes up 1 column on large screens (right side) */}
          <div className="lg:col-span-1">
            {/* This div creates the empty space on the right */}
          </div>
          
          {/* Google Maps - takes up 2 columns on large screens (left side) */}
          ...
          {/* Location Information - takes up 1 column (next to map) */}
