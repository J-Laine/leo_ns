...
export function Footer() {
  const footerLinks = [
    { href: '/palvelut-hinnasto', label: 'Palvelut ja hinnasto' },
    { href: '/tietoa-minusta', label: 'Tietoa minusta' },
    { href: '/asiakkaiden-kokemuksia', label: 'Asiakkaiden kokemuksia' },
    { href: '/lahjakortti', label: 'Lahjakortti' },
